...
```tsx
import { Card, CardHeader, CardTitle, CardSubtitle, CardContent, CardMedia } from "@impactxlab/ds-education"
...
```tsx
import { DropdownMenu } from "@impactxlab/ds-education"
