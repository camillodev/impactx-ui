# Publishing — onde vive o package `@impactxlab/design-system`

> **REGRA DURA:** o DS NÃO é publicado no npm público. Vive em **GitHub Packages**.

## Onde está

- **Package:** `@impactxlab/design-system`
...
- PR imediata em release nova de `@impactxlab/design-system` (label `ds-update`)
