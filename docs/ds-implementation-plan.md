...
| # | Critério | Como medir |
|---|---|---|
| F1 | Bot cria página de lista completa em ≤ 15 linhas usando só `@impactxlab/design-system` | Reescrever `kumon-app/src/app/alunos/page.tsx` |
...
❌ Inventar componente que já existe em `@impactxlab/design-system` — sempre checar antes
...
```markdown
# Button — `@impactxlab/design-system`
