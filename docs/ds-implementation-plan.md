...
| # | Critério | Como medir |
|---|---|---|
| F1 | Bot cria página de lista completa em ≤ 15 linhas usando só `@impactx/ds-education` | Reescrever `kumon-app/src/app/alunos/page.tsx` |
...
❌ Inventar componente que já existe em `@impactx/ds-education` — sempre checar antes
