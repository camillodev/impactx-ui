...
import { Textarea, Label, CodeBlock } from "@impactxlab/ds-education"
      ...
      <section className="max-w-3xl">
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <CodeBlock language="tsx">{`import { Textarea } from "@impactxlab/ds-education"
...
/>`}</CodeBlock>
          ...
          <div>
            ...
            <CodeBlock language="tsx">{`import { Label, Textarea } from "@impactxlab/ds-education"
